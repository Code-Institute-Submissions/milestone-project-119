...
let beachLocations = [
        {coords: {lat:50.416308, lng:-5.099469}, // Fistral Beach
        ...
        {coords: {lat:50.3483394, lng:-5.157094 }, // Perranporth Beach
        ...
        {coords: {lat:49.9732734, lng:-5.2337851 }, // Kynance Cove
        ...
        {coords: {lat:50.1988996, lng:-5.4682206}, // Carbis Bay Beach
        ...
        {coords: {lat:50.3908849, lng:-5.1483663 }, // Holywell Bay Beach
        ...
        {coords: {lat:50.0429263, lng:-5.6527166 }, // Porthcurno Beach
        ...
        {coords: {lat:50.0535378, lng:-5.6944491}, // Nanjizal Beach
        ...
        {coords: {lat:50.1440767, lng:-5.0686287}, // Gyllyngvase Beach
        ...
        {coords: {lat:50.3233711, lng:-4.7681669}, // Porthpean Beach
        ...
        {coords: {lat:50.8603023,lng:-4.5586691}, // Sandymouth Bay Beach
        ...
        {coords: {lat:50.2894403, lng:-4.7821893}, // Pentewan Beach
        ...
        {coords: {lat:50.6447762, lng:-4.7626325}, // Trebarwith Beach
        ...
        {coords: {lat:50.6683152, lng:-4.7614876}, // Tintagel Haven
        ...
        {coords: {lat:50.5752425, lng:-4.918991}, // Polzeath Beach
        ...
        {coords: {lat:50.3528852, lng:-4.273459}, // Tregantle Beach
        ...
        {coords: {lat:50.3305601, lng:-4.5187893}, // Polperro Beach
...
let activityLocations = [
        {coords: {lat:50.299441, lng:-5.1055211}, // Bedlam Paintball Truro
        ...
        {coords: {lat:50.5184814, lng:-4.8407397}, // Camel Trail Cycle Hire
        ...
        {coords: {lat:50.5984694, lng:-4.7351817}, // Big Dunk's Outdoor Lazer Tag
        ...
        {coords: {lat:50.4151414, lng:-5.0890206}, // Escape Surf School
        ...
        {coords: {lat:50.3048844, lng:-5.1903987}, // Koru Kayaking Adeventures
        ...
        {coords: {lat:50.2740266, lng:-5.1872099}, // ATV Centre Ltd
        ...
        {coords: {lat:50.4113864, lng:-5.0716177}, // Newquay Zoo
        ...
        {coords: {lat:50.0951818, lng:-5.2080155}, // Cornish Seal Sanctuary
        ...
        {coords: {lat:50.0920744, lng:-5.2622836}, // Flambards Theme Park
        ...
        {coords: {lat:49.9679088, lng:-5.2080712}, // Lizard Adventure
        ...
        {coords: {lat:50.5413889, lng:-4.8642663}, // Cornish Coasteering
        ...
        {coords: {lat:50.1166804, lng:-5.5506217}, // Kernow Coasteering
        ...
        {coords: {lat:50.3596247, lng:-4.1330105}, // Mount Batten Outdoor Climbing Wall
        ...
        {coords: {lat:50.5597671, lng:-4.6760462}, // Hallagenna Riding
        ...
        {coords: {lat:50.1461954, lng:-5.5181397}, // Tremenheere Riding Stables
        ...
        {coords: {lat:50.2092802, lng:-5.479281}, // St Ives Watersports
        ...
        {coords: {lat:50.3750794, lng:-5.0437649}, // Lappa Valley Steam Railway
        ...
        {coords: {lat:50.3829806, lng:-5.0117826}, // Dairyland Farm Park
        ...
        {coords: {lat:50.3472852,lng:-4.7535074}, // Cornwall Football Golf
        ...
        {coords: {lat:50.2661006, lng:-5.0552758}, // Truro Bowl
        ...
        {coords: {lat:50.0380941, lng:-5.2640414}, // Mullion Golf Club
...
let restaurantLocations = [
        {coords: {lat:50.5401069, lng:-4.938946}, // The Seafood Restaurant
        ...
        {coords: {lat:50.6635645, lng:-4.753678}, // King Arthurs Arms Inn
        ...
        {coords: {lat:50.4117706, lng:-5.1210257}, // Lewinnick Lodge
        ...
        {coords: {lat:50.3182604, lng:-5.2045607}, // The Driftwood Spars
        ...
        {coords: {lat:50.4442014, lng:-5.0440957}, // The Beach Hut
        ...
        {coords: {lat: 50.3688044, lng:-4.9865617}, // The Fox's Revenge
        ...
        {coords: {lat:50.2741604, lng:-4.7882751}, // The Nutty Duck
        ...
        {coords: {lat:50.2132507, lng:-5.4826186}, // Beer & Bird
        ...
        {coords: {lat:50.118647, lng:-5.5357156}, // Old Lifeboat House Bistro
        ...
        {coords: {lat:50.5414871, lng:-4.9421653}, // Paul Ainsworth Number 6
        ...
        {coords: {lat:50.3358357, lng:-4.6368888}, // Appleton's Bar and Restaurant
        ...
        {coords: {lat:50.2293495, lng:-5.3889681}, // The Rockpool
        ...
        {coords: {lat:50.5933214, lng:-4.8274969}, // The Angry Anchovy
        ...
        {coords: {lat:50.2627936, lng:-5.0535122}, // Manning's Bar and Restaurant
        ...
        {coords: {lat:50.2378956, lng:-5.2489994}, // Tricky's
        ...
        {coords: {lat:50.1525864, lng:-5.0686506}, // Cribbs Cornwall
        ...
        {coords: {lat:50.1234351, lng:-5.4766158}, // The Godolphin
        ...
        {coords: {lat:50.1010554, lng:-5.2768267}, // Henley's Bar and Restaurant
        ...
        {coords: {lat:49.9679807, lng:-5.2055365}, // The Witchball
        ...
        {coords: {lat:50.0657729, lng:-5.7167688}, // The Land's End Restaurant and Bar
...
let natureLocations = [
        {coords: {lat:50.285367, lng:-4.8133752}, // Lost Gardens of Heligan
        ...
        {coords: {lat:50.1067235, lng:-5.1239471}, // Trebah Gardens
        ...
        {coords: {lat:50.4767156, lng:-4.784576}, // Camel Valley Vineyard 
        ...
        {coords: {lat:50.378775, lng:-4.6840813}, // Hidden Valley Gardens
        ...
        {coords: {lat:50.0632964, lng:-5.5699571}, // Chygurno Gardens
        ...
        {coords: {lat:50.1859412, lng:-5.0979424}, // Enys Gardens
        ...
        {coords: {lat:50.1091128, lng:-5.1192471}, // Glendurgen Gardens
        ...
        {coords: {lat:50.6708412, lng:-4.7272415}, // St Nectan's Glen
        ...
        {coords: {lat:50.091692, lng:-5.1241721}, // Bosahan Gardens
        ...
        {coords: {lat:50.4423936, lng:-4.7013472}, // Lanhydrock House and Gardens
        ...
        {coords: {lat:50.4555128, lng:-5.0001858}, // The Japanese Garden
        ...
        {coords: {lat:50.4702743, lng:-4.6786729}, // Cardinham Woods
        ...
        {coords: {lat:50.1366064, lng:-5.5083667}, // Tremenheere Sculpture Gardens
        ...
        {coords: {lat:50.2172203, lng:-5.034446}, // Trelissick Gardens
        ...
        {coords: {lat:50.2913108, lng:-5.0618025}, // Idless Woods
        ...
        {coords: {lat:50.4903549, lng:-4.5075518}, // Golitha Falls
        ...
        {coords: {lat:50.5548086, lng:-4.6178319}, // Bodmin Moore
...
let hotelLocations = [
        {coords: {lat:50.4446539, lng:-5.0434669}, // Watergate Bay Hotel
        ...
        {coords: {lat:50.3359557, lng:-4.6362102}, // The Old Quay House Hotel
        ...
        {coords: {lat:50.0646398, lng:-5.5706962}, // The Cove Lamorna
        ...
        {coords: {lat:50.5404889, lng:-4.9398744}, // Rick Steins St Edmunds House
        ...
        {coords: {lat:50.0252684, lng:-5.1004173}, // The Bay Hotel
        ...
        {coords: {lat:50.0832088, lng:-5.5390743}, // Ship Inn
        ...
        {coords: {lat:50.184234, lng:-5.5961044}, // Gurnards Head Hotel
        ...
        {coords: {lat:50.0219264, lng:-5.2558797}, // Polurrian on the Lizard
        ...
        {coords: {lat:50.1580258, lng:-5.0177567}, // St Mawes Hotel
        ...
        {coords: {lat:50.3359522, lng:-4.7413545}, // The Carlyon Bay Hotel
        ...
        {coords: {lat:50.6682234, lng:-4.757652}, // Camelot Castle Hotel
        ...
        {coords: {lat:50.3053767, lng:-5.2161079}, // Beacon Country House Hotel
        ...
        {coords: {lat:50.1591359, lng:-5.01552}, // The Idle Rocks
        ...
        {coords: {lat:50.3398108, lng:-4.4972886}, // Tallard Bay Hotel
        ...
        {coords: {lat:50.2075034, lng:-4.9413554}, // The Nare Hotel
        ...
        {coords: {lat:50.2662784, lng:-5.0461957}, // The Alverton Hotel
        ...
        {coords: {lat:50.1982306, lng:-5.4687445}, // Carbis Bay Hotel
        ...
        {coords: {lat:50.1236677, lng:-5.4755258}, // Marizion Hotel
        ...
        {coords: {lat:50.6380725, lng:-4.3647504}, // The Eagle House Hotel
        ...
        {coords: {lat:50.0656501, lng:-5.71666}, // The Land's End Hotel
...
let artsLocations = [
        {coords: {lat:50.0413674, lng:-5.6531434}, // The Minack Theatre
        ...
        {coords: {lat:50.2641193, lng:-5.0534362}, // Truro Cathedral
        ...
        {coords: {lat:50.1461128, lng:-5.0488191}, // Pendennis Castle
        ...
        {coords: {lat:50.6672847, lng:-4.760694}, // Tintagel Castle
        ...
        {coords: {lat:50.3601378, lng:-4.7469065}, // Eden Project 
        ...
        {coords: {lat:50.1165102, lng:-5.4802691}, // St Michael's Mount
        ...
        {coords: {lat:50.2148385, lng:-5.4846445}, // Tate St Ives
        ...
        {coords: {lat:50.2133028, lng:-5.4832626}, // Barbara Hepworth Museum
        ...
        {coords: {lat:50.1517431, lng:-5.6784109}, // Geevor Tin Mine
        ...
        {coords: {lat:50.4748864, lng:-4.7307867}, // Bodmin Jail
        ...
        {coords: {lat:50.3226815, lng:-5.2027042}, // St Agnes Heritage Coast
        ...
        {coords: {lat:50.1556299, lng:-5.0746233}, // Falmouth Art Gallery
        ...
        {coords: {lat:50.2393609, lng:-4.8488722}, // Caerhays Castle
        ...
        {coords: {lat:50.386793, lng:-5.0410428}, // Trerice Manor
        ...
        {coords: {lat:50.2626163, lng:-5.0528392}, // Hall for Cornwall
